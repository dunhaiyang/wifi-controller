...
//    INT32 xdata perByte;
//    INT32 xdata perBit;
//    const UINT32 xdata poly = 0x04C11DB7;
//    UINT32 xdata crc_value = 0xFFFFFFFF;
//    UINT8 xdata c;
